  ...
  return (
    <div className="mb-4">
      ...
      <div className="relative">
        {isSelect ? (
          <select
            className="w-full bg-transparent border border-gray-300 rounded-md outline-none py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500"
            value={value}
